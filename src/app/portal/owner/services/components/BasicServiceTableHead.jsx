...
function BasicServiceTableHead({ headings, order, orderBy, onSelectAllRows, onRequestSort, numSelected, rowCount }) {
  return (
    <TableHead>
      <TableRow>
...
BasicServiceTableHead.propTypes = {
...
export default BasicServiceTableHead;
